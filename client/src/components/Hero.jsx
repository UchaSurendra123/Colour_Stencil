...
//               style={{ animationDelay: '0.25s' }}
//             >
//               <span className="text-gradient font-medium"></span> Stenciling the Strategy
//             </h1>
//           </div>
...
//             style={{ animationDelay: '0.3s' }}
//           >
//             We are Colorstencil. A design agency built on ownership, not outsourcing. We turn complex brand challenges into clear, vibrant realities.
//           </p>
    ...
    <section className="min-h-screen flex items-center justify-center bg-gradient-dark pt-20">
      <div className="container mx-auto px-6 max-w-7xl">
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="mb-12">
            <h1 
              className="font-display text-6xl md:text-7xl lg:text-8xl text-foreground leading-[0.95] font-light mb-4 animate-fade-up"
              style={{ animationDelay: '0.2s' }}
            >
              <span className="text-primary">Color</span>ing the Experience
            </h1>
            <h1 
              className="font-display text-7xl md:text-8xl lg:text-9xl text-foreground leading-[0.95] font-normal animate-fade-up"
              style={{ animationDelay: '0.25s' }}
            >
              <span className="text-primary">Stencil</span>ing the Strategy
            </h1>
          </div>
